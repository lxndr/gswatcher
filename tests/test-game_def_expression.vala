...
public static int main (string[] args) {
  ...
  CorrectTableItem[] CORRECT_TABLE = {
    ...
    { name: "string_malformed", pattern: "\"invalid string",                                        result: null,           error: new GameDef.ExpressionParserError.INVALID_TOKEN ("invalid token at position 16")                                },
    ...
    { name: "map_malformed",    pattern: "map[\"key\"",                                             result: null,           error: new GameDef.ExpressionParserError.INVALID_TOKEN ("invalid token at position 9")                                 },
    ...
    { name: "fn_unknown",       pattern: "unknownFn()",                                             result: null,           error: new GameDef.ExpressionParserError.INVALID_TOKEN ("unknown function 'unknownFn' at position 11")                 },
    { name: "fn_malformed",     pattern: "regex(\"user (\\\\d)\",",                                 result: null,           error: new GameDef.ExpressionParserError.INVALID_TOKEN ("invalid token at position 19")                                },
