...
!function() {
/*!*******************************************!*\
  !*** ./protocols/gamespy2.ts + 5 modules ***!
  \*******************************************/
// ESM COMPAT FLAG
...
;// CONCATENATED MODULE: ./protocols/gamespy2.ts
...
var requestID = 0;
var query = function () {
    requestID = genRandomInteger(0, Math.pow(256, 4));
...
var normalizeServerInfo = function (inf) {
    ...
    return (_a = {},
        ...
        _a["secure" /* SECURE */] = inf.sv_punkbuster === '1',
        _a);
};
var parseServerInfo = function (r, delimiter) {
    var inf = {};
    while (!r.is_end) {
        var key = r.zstring(delimiter);
...
var readPlayerFields = function (r, delimiter) {
    var fields = [];
    while (!r.is_end) {
        var field = r.zstring(delimiter);
        if (!field) {
            break;
        }
        fields.push(field);
